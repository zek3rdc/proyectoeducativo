...
def mostrar():
    ...
    if opcion == "Agregar Materia":
        ...
        # Verificar si hay materias y secciones
        if not materias:
            st.warning("No hay materias registradas en la base de datos.")
        elif not secciones:
            st.warning("No hay secciones registradas en la base de datos.")
        else:
